...
class SetupWizard extends Page {
	...
	get registeredServer() { return browser.element('[data-qa="setup-wizard"] [data-qa="registerServer"][value="true"]'); }

	get standaloneServer() { return browser.element('[data-qa="setup-wizard"] [data-qa="registerServer"][value="false"]'); }
